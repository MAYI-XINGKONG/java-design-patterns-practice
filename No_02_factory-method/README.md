...
├── main/
│   ├── java/
│   │   ├── Blacksmith.java                # 锻造厂接口（工厂接口）
│   │   ├── Weapon.java                    # 武器接口（产品接口）
│   │   ├── WeaponType.java                # 武器类型枚举
│   │   ├── impl/                          # 具体产品实现包
│   │   │   ├── ElfBlacksmith.java         # 精灵锻造厂实现
│   │   │   ├── ElfWeapon.java             # 精灵武器基类
│   │   │   ├── ElvishSword.java           # 精灵剑具体实现
│   │   │   ├── ElvishAxe.java             # 精灵斧头具体实现
│   │   │   ├── OrcBlacksmith.java         # 兽人锻造厂实现
│   │   │   ├── OrcWeapon.java             # 兽人武器基类
│   │   │   ├── OrcishSword.java           # 兽人剑具体实现
│   │   │   └── OrcishAxe.java             # 兽人斧头具体实现
│   │   │
│   │   └── factory/
│   │       └── WeaponFactory.java        # 武器工厂抽象类或接口
│   │       
│   └── resources/
